...
function SearchAutocomplete({
  ...
  return (
    <div ref={wrapperRef} className={`relative ${className}`}>
      ...
      {showDropdown && (
        <div
          className="absolute top-full left-0 right-0 mt-1.5 rounded-xl border border-gray-200/50 dark:border-white/10 bg-white dark:bg-[#121a14] shadow-2xl shadow-black/25 z-50 overflow-hidden max-h-80 overflow-y-auto"
          role="listbox"
        >
          {!dataLoaded ? (
